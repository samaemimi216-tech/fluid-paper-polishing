...
面向流体力学、计算流体力学与传热传质论文的 Codex 学术写作技能。它借鉴 [nature-skills](https://github.com/Yuan1z0825/nature-skills) 的动态路由和渐进加载设计，并根据流体领域论文补充物理条件、数值证据、术语与期刊表达规范。
...
| 章节 | title-abstract、introduction、formulation-methods、verification-validation、results-discussion、conclusion、captions |
| 语言 | en、zh-to-en |
| 期刊 | JCP、IJHMT、PRE、generic |
| 物理领域 | general-fluids、kinetic-rarefied、heat-radiation、multiphase-reacting |
...
本技能参考了仓库开发目录中的 29 篇流体、传热和辐射输运论文，代表性期刊包括 *Journal of Computational Physics*、*International Journal of Heat and Mass Transfer* 与 *Physical Review E*。语料仅用于总结论证结构、术语和领域表达习惯，不复制论文原句。
