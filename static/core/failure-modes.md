...
- numerical property is claimed without matching evidence;
- comparison lacks aligned conditions or a named baseline;
- observation and mechanism are conflated;
- assumptions, boundary conditions, uncertainty, or applicability limits are missing;
- terminology or notation drifts;
